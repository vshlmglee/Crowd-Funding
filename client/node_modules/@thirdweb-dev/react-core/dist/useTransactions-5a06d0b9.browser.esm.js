  ...
  useEffect(() => {
    const handleSwitchAccount = async data => {
      ...
      try {
        ...
        console.warn(`[Auth] Failed to switch account to ${data.address} with error:\n`, err);
      }
    };
