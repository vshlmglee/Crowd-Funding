...
class MarketplaceDirect {
  constructor(contractWrapper, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "createListing", contractPublisher.buildTransactionFunction(async listing => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "createListingsBatch", contractPublisher.buildTransactionFunction(async listings => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "makeOffer", contractPublisher.buildTransactionFunction(async (listingId, quantityDesired, currencyContractAddress, pricePerToken, expirationDate) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "acceptOffer", contractPublisher.buildTransactionFunction(async (listingId, addressOfOfferor) => {
      /**
       * TODO:
     ...
     */
    QueryParams._defineProperty(this, "buyoutListing", contractPublisher.buildTransactionFunction(async (listingId, quantityDesired, receiver) => {
     ...
     */
    QueryParams._defineProperty(this, "updateListing", contractPublisher.buildTransactionFunction(async listing => {
      return contractPublisher.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
     ...
     * ```
     */
    QueryParams._defineProperty(this, "cancelListing", contractPublisher.buildTransactionFunction(async listingId => {
      return contractPublisher.Transaction.fromContractWrapper({
        contractWrapper: this.contractWrapper,
...
class MarketplaceAuction {
  constructor(contractWrapper, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "buyoutListing", contractPublisher.buildTransactionFunction(async listingId => {
      const listing = await this.validateListing(ethers.BigNumber.from(listingId));
     ...
     * ```
     */
    QueryParams._defineProperty(this, "makeBid", contractPublisher.buildTransactionFunction(async (listingId, pricePerToken) => {
      const listing = await this.validateListing(ethers.BigNumber.from(listingId));
     ...
     */
    QueryParams._defineProperty(this, "closeListing", contractPublisher.buildTransactionFunction(async (listingId, closeFor) => {
      if (!closeFor) {
     ...
     * @param listingId - the auction  listing ud to close
     */
    QueryParams._defineProperty(this, "executeSale", contractPublisher.buildTransactionFunction(async listingId => {
      const listing = await this.validateListing(ethers.BigNumber.from(listingId));
      try {
        const winningBid = await this.getWinningBid(listingId);
