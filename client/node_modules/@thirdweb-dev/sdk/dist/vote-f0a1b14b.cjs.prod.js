...
class Vote {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "propose", contractPublisher.buildTransactionFunction(async (description, executions) => {
      if (!executions) {
        executions = [{
     ...
     */
    QueryParams._defineProperty(this, "vote", contractPublisher.buildTransactionFunction(async function (proposalId, voteType) {
     ...
     */
    QueryParams._defineProperty(this, "execute", contractPublisher.buildTransactionFunction(async proposalId => {
