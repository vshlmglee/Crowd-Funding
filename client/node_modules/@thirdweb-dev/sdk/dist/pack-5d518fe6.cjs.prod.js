...
var zod = require('zod');
var hasERC20Allowance = require('./hasERC20Allowance-234e2688.cjs.prod.js');
require('bn.js');
...
class PackVRF {
  constructor(network, address, storage, options, chainId) {
     ...
     * @twfeature PackVRF
     */
    QueryParams._defineProperty(this, "open", contractPublisher.buildTransactionFunction(async function (tokenId) {
     ...
     * @twfeature PackVRF
     */
    QueryParams._defineProperty(this, "claimRewards", contractPublisher.buildTransactionFunction(async function () {
...
class Pack extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "create", contractPublisher.buildTransactionFunction(async metadataWithRewards => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "addPackContents", contractPublisher.buildTransactionFunction(async (packId, packContents) => {
      const signerAddress = await this.contractWrapper.getSignerAddress();
     ...
     * ```
     */
    QueryParams._defineProperty(this, "createTo", contractPublisher.buildTransactionFunction(async (to, metadataWithRewards) => {
  ...
  async isTransferRestricted() {
    const anyoneCanTransfer = await this.contractWrapper.readContract.hasRole(contractPublisher.getRoleHash("transfer"), ethers.ethers.constants.AddressZero);
