...
class StandardErc20 {
  ...
  constructor(contractWrapper, storage, chainId) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", contractPublisher.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferFrom", contractPublisher.buildTransactionFunction(async (from, to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "setAllowance", contractPublisher.buildTransactionFunction(async (spender, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transferBatch", contractPublisher.buildTransactionFunction(async args => {
