...
var erc20History = require('./erc-20-history-cb20cbcc.cjs.prod.js');
var erc20Standard = require('./erc-20-standard-0eb00a4f.cjs.prod.js');
...
class Token extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", contractPublisher.buildTransactionFunction(async amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", contractPublisher.buildTransactionFunction(async (to, amount) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", contractPublisher.buildTransactionFunction(async args => {
     ...
     * @alpha
     */
    QueryParams._defineProperty(this, "delegateTo", contractPublisher.buildTransactionFunction(async delegateeAddress => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", contractPublisher.buildTransactionFunction(amount => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnFrom", contractPublisher.buildTransactionFunction(async (holder, amount) => {
