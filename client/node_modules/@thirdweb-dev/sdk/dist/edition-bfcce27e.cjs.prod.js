...
var erc1155Standard = require('./erc-1155-standard-485b63bc.cjs.prod.js');
...
class Edition extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "mint", contractPublisher.buildTransactionFunction(async metadataWithSupply => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", contractPublisher.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintAdditionalSupply", contractPublisher.buildTransactionFunction(async (tokenId, additionalSupply) => {
     ...
     * @param additionalSupply - the additional amount to mint
     */
    QueryParams._defineProperty(this, "mintAdditionalSupplyTo", contractPublisher.buildTransactionFunction(async (to, tokenId, additionalSupply) => {
     ...
     */
    QueryParams._defineProperty(this, "mintBatch", contractPublisher.buildTransactionFunction(async metadatas => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", contractPublisher.buildTransactionFunction(async (to, metadataWithSupply) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", contractPublisher.buildTransactionFunction(async (tokenId, amount) => {
