...
class TokenDrop extends erc20Standard.StandardErc20 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claim", contractPublisher.buildTransactionFunction(async function (amount) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", contractPublisher.buildTransactionFunction(async function (destinationAddress, amount) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", contractPublisher.buildTransactionFunction(async amount => {
