...
class StandardErc1155 {
  ...
  constructor(contractWrapper, storage, chainId) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", contractPublisher.buildTransactionFunction(async function (to, tokenId, amount) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "airdrop", contractPublisher.buildTransactionFunction(async function (tokenId, addresses) {
