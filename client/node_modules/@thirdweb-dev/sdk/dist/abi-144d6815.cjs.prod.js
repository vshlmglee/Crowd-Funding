...
const PropertiesInput = zod.z.object({}).catchall(zod.z.union([contractPublisher.BigNumberTransformSchema, zod.z.unknown()]));
...
async function directDeployDeterministic(bytecode, abi, signer, constructorArgs, saltForCreate2) {
  ...
  const encodedArgs = ethers.ethers.utils.defaultAbiCoder.encode(constructorParamTypes, paramValues);
