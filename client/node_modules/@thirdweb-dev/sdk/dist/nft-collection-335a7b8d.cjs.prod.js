...
class NFTCollection extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mint", contractPublisher.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintTo", contractPublisher.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatch", contractPublisher.buildTransactionFunction(async metadata => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "mintBatchTo", contractPublisher.buildTransactionFunction(async (walletAddress, metadata) => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burn", contractPublisher.buildTransactionFunction(tokenId => {
