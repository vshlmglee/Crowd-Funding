...
var erc721Standard = require('./erc-721-standard-51a70971.cjs.prod.js');
var thirdwebCheckout = require('./thirdweb-checkout-ee948883.cjs.prod.js');
...
class NFTDrop extends erc721Standard.StandardErc721 {
  ...
  constructor(network, address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "createBatch", contractPublisher.buildTransactionFunction(async (metadatas, options) => {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", contractPublisher.buildTransactionFunction(async function (destinationAddress, quantity) {
     ...
     * @returns - an array of results containing the id of the token claimed, the transaction receipt and a promise to optionally fetch the nft metadata
     */
    QueryParams._defineProperty(this, "claim", contractPublisher.buildTransactionFunction(async function (quantity) {
     ...
     *
     */
    QueryParams._defineProperty(this, "burn", contractPublisher.buildTransactionFunction(async tokenId => {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "transfer", contractPublisher.buildTransactionFunction(async (to, tokenId) => {
     ...
     * @internal
     */
    QueryParams._defineProperty(this, "setApprovalForAll", contractPublisher.buildTransactionFunction(async (operator, approved) => {
     ...
     * @internal
     */
    QueryParams._defineProperty(this, "setApprovalForToken", contractPublisher.buildTransactionFunction(async (operator, tokenId) => {
