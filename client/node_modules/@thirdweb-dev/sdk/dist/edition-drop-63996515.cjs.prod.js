...
class EditionDrop extends erc1155Standard.StandardErc1155 {
  ...
  constructor(network, _address, storage) {
     ...
     */
    QueryParams._defineProperty(this, "claimTo", contractPublisher.buildTransactionFunction(async function (destinationAddress, tokenId, quantity) {
     ...
     * @returns - Receipt for the transaction
     */
    QueryParams._defineProperty(this, "claim", contractPublisher.buildTransactionFunction(async function (tokenId, quantity) {
     ...
     * ```
     */
    QueryParams._defineProperty(this, "burnTokens", contractPublisher.buildTransactionFunction(async (tokenId, amount) => {
